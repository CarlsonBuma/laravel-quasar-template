            ...
            <CardSimple title="Impressum">        
                <q-card-section>
                    <FormWrapper
                        ...
                        buttonIcon="update"
                        @submit="submitBusinessImpressum(entity.website, entity.contact)"
                    >
...
export default {
    ...
    components: {
        NavUserEntity, FormWrapper, GoogleLocation, CardUploadImage
    },
    ...
    methods: {
        ...
        async submitBusinessImpressum(website, contact) {
            try {
                this.$toast.load();
